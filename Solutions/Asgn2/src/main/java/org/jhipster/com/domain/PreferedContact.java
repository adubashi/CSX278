...
public class PreferedContact implements Serializable {
    ...
    @OneToMany(mappedBy = "preferedMethodOfContact")
    @JsonIgnore
    @Cache(usage = CacheConcurrencyStrategy.NONSTRICT_READ_WRITE)
    ...
    public PreferedContact addStudents(Student student) {
        students.add(student);
        student.setPreferedMethodOfContact(this);
        return this;
    }

    public PreferedContact removeStudents(Student student) {
        students.remove(student);
        student.setPreferedMethodOfContact(null);
        return this;
    }
