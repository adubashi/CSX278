...
public class Student implements Serializable {
    ...
    @ManyToOne
    private PreferedContact preferedMethodOfContact;
    ...
    public School getCollege() {
        return college;
    }

    public Student college(School school) {
        this.college = school;
        return this;
    }
    ...
    public PreferedContact getPreferedMethodOfContact() {
        return preferedMethodOfContact;
    }

    public Student preferedMethodOfContact(PreferedContact preferedContact) {
        this.preferedMethodOfContact = preferedContact;
        return this;
    }

    public void setPreferedMethodOfContact(PreferedContact preferedContact) {
        this.preferedMethodOfContact = preferedContact;
    }
